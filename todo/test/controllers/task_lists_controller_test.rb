...
class TaskListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_list" do
    assert_difference('TaskList.count') do
      post task_lists_url, params: { task_list: { completed_at: @task_list.completed_at, deleted_at: @task_list.deleted_at, description: @task_list.description, title: @task_list.title } }
    end
  ...
  test "should update task_list" do
    patch task_list_url(@task_list), params: { task_list: { completed_at: @task_list.completed_at, deleted_at: @task_list.deleted_at, description: @task_list.description, title: @task_list.title } }
